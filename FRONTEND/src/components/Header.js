            ...
            <div class="ch-header-inner">
                ...
                <div class="ch-right">
                    ...
                    <div class="ch-capital" id="header-capital-area" onclick="window.router.navigate('/funding')" style="${currentRoute === '/funding' ? 'display: none !important;' : ''}">
                        ...
                        <span id="header-avail-cap" style="font-size: 13px; font-weight: 700; color: var(--ink-2, #4A5464); font-variant-numeric: tabular-nums; font-family: var(--mono, 'IBM Plex Mono', monospace);">&mdash; ADD FUNDS</span>
                    </div>
