                    ...
                    <a href="/#/rivalry" class="ctp-card rivalry" onclick="document.getElementById('ctp-overlay').classList.remove('open')">
                        <div class="ctp-card-icon rivalry">
                            <svg width="20" height="20" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M5.5 26.5L22 10" stroke="#752122" stroke-width="1.5" stroke-linecap="round"/>
                                <path d="M22 10L26.5 5.5" stroke="#752122" stroke-width="2" stroke-linecap="round"/>
                                <path d="M26.5 5.5L28 4" stroke="#752122" stroke-width="1" stroke-linecap="round"/>
                                <rect x="19.5" y="10" width="7" height="1.6" rx="0.8" transform="rotate(-45 19.5 10)" fill="#752122"/>
                                <line x1="9" y1="23" x2="7.5" y2="24.5" stroke="#752122" stroke-width="2.4" stroke-linecap="round" opacity="0.6"/>
                                <line x1="7" y1="25" x2="5.5" y2="26.5" stroke="#752122" stroke-width="2.4" stroke-linecap="round" opacity="0.4"/>
                                <circle cx="4.5" cy="27.5" r="1.5" fill="#752122"/>
                                <path d="M26.5 26.5L10 10" stroke="#752122" stroke-width="1.5" stroke-linecap="round"/>
                                <path d="M10 10L5.5 5.5" stroke="#752122" stroke-width="2" stroke-linecap="round"/>
                                <path d="M5.5 5.5L4 4" stroke="#752122" stroke-width="1" stroke-linecap="round"/>
                                <rect x="7" y="10" width="7" height="1.6" rx="0.8" transform="rotate(45 7 10)" fill="#752122"/>
                                <line x1="23" y1="23" x2="24.5" y2="24.5" stroke="#752122" stroke-width="2.4" stroke-linecap="round" opacity="0.6"/>
                                <line x1="25" y1="25" x2="26.5" y2="26.5" stroke="#752122" stroke-width="2.4" stroke-linecap="round" opacity="0.4"/>
                                <circle cx="27.5" cy="27.5" r="1.5" fill="#752122"/>
                            </svg>
                        </div>
