        ...
        <div class="lp">
            ...
            <div class="lw">
                <div class="lhero" data-r>
                    ...
                    <div class="ltrust">
                        <strong>Not gambling.</strong> No odds. No chance. No opponent. You stake against your own verified performance.
                    </div>
                </div>
            </div>
                ...
                <div class="lhow" data-r id="how">
                    ...
                    <div class="lsteps">
                        ...
                        <div class="lstep">
                            ...
                            <div class="lstep-p">Collateral monitors progress through connected sources like Stripe, X, Shopify, and Amazon.</div>
                        </div>
                        <div class="lstep">
            ...
            <div class="lsources">
                <div class="lsources-in">
                    <span class="lmono" style="color:var(--t2)">Verified Sources</span>
                    <span class="lsrc">Stripe</span>
                    <span class="lsrc">X / Twitter</span>
                    <span class="lsrc">Shopify</span>
                    <span class="lsrc">Amazon</span>
                    <span class="lsrc">YouTube</span>
                </div>
            </div>
            ...
            <div class="lfoot">
                ...
                <div class="lfoot-micro">Stripe · X · Shopify · Amazon · YouTube</div>
