    ...
    return `
        <div class="lp cl-root">
            ...
            <section class="cs" id="manifesto" aria-labelledby="cs-heading" style="position:relative; background:#FDFBF7; padding:124px 24px 132px; box-sizing:border-box; width:100%; overflow:hidden; isolation:isolate;">
                <div class="cs-stamp" aria-hidden="true" style="position:absolute; z-index:1; left:50%; bottom:292px; width:168px; height:168px; min-height:168px; max-height:none; flex:none; aspect-ratio:auto; background-image:url('/assets/images/official-collateral-seal.png'); background-size:contain; background-position:center; background-repeat:no-repeat; transform:translateX(348px) rotate(-9deg); pointer-events:none; user-select:none;"></div>
