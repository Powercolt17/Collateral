            ...
            <div class="lw" style="padding-top: 80px; padding-bottom: 40px;">
                <div class="ltypes-asymmetric" data-r>
                    ...
                    <div class="ltypes-right">
                        <!-- CONCEPTUAL MARKETING PROTOCOL ILLUSTRATION -->
                        <div class="proto-diagram-wrapper reveal-item">
                            <!-- SVG Vector Path Connections Layer -->
                            <svg class="proto-svg-canvas" viewBox="0 0 540 310" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <defs>
                                ...
                                <path id="path-left" d="M 120 65 C 190 65, 210 140, 270 140" stroke="url(#beam-grad-left)" stroke-width="2.5" stroke-dasharray="5 5" fill="none" />
                                <!-- Incoming Path Right: Opponent -> Vault -->
                                <path id="path-right" d="M 420 65 C 350 65, 330 140, 270 140" stroke="url(#beam-grad-right)" stroke-width="2.5" stroke-dasharray="5 5" fill="none" />
                                <!-- Outgoing Path Down: Vault -> Settlement Endpoint -->
                                <path id="path-down" d="M 270 205 L 270 255" stroke="url(#payout-grad)" stroke-width="2.5" stroke-dasharray="4 4" fill="none" />

                                <!-- Animated Pulses Along Paths -->
                                <circle class="proto-pulse-circle" r="4" fill="#7A1220">
                                    <animateMotion dur="2.4s" repeatCount="indefinite" path="M 120 65 C 190 65, 210 140, 270 140" />
                                </circle>
                                <circle class="proto-pulse-circle" r="4" fill="#7A1220">
                                    <animateMotion dur="2.4s" repeatCount="indefinite" path="M 420 65 C 350 65, 330 140, 270 140" />
                                </circle>
                                <circle class="proto-pulse-circle" r="4" fill="#22C55E">
                                    <animateMotion dur="2.8s" repeatCount="indefinite" path="M 270 205 L 270 255" />
                                </circle>
                            </svg>

                            <!-- UI Node Layers Overlay -->
                            <div class="proto-nodes-layer">
                                ...
                                <!-- Center Vault Anchor Node -->
                                <div class="proto-vault-anchor">
                                    <div class="vault-lock-ring">
                                    ...
                                    <div class="vault-pool-val">$2,000 WINNER POOL</div>
                                    <div class="vault-tag">WINNER TAKES ALL</div>
                                </div>
