...
.lh-gradient{background:linear-gradient(135deg, var(--r) 0%, #9B1C1C 100%);-webkit-background-clip:text;-webkit-text-fill-color:transparent;font-weight:800;letter-spacing:-2px;display:inline-block}
