...
/* ═══════════════════════════════════════════════════════════════════════════
   SCROLL ANIMATIONS & INSTITUTIONAL MOTION SYSTEM STYLES
   ═══════════════════════════════════════════════════════════════════════════ */

/* Rule 6: Tabular figures */
.meter-val, .row-amt, .demo-amt, .demo-ledger dd, #m-escrow, #m-settled, #m-count, #clock {
    font-variant-numeric: tabular-nums !important;
    display: inline-block;
}
...
/* Base state (CSS DEFAULT): 100% VISIBLE */
...
/* Start states ONLY apply when html has .js-motion-active class */
html.js-motion-active .reveal,
html.js-motion-active .r-item,
html.js-motion-active .r-plate,
html.js-motion-active .receipt-card,
html.js-motion-active .rc-card,
html.js-motion-active .leaf,
html.js-motion-active .reg,
html.js-motion-active .cmp,
html.js-motion-active .faq-item,
html.js-motion-active .calc-card {
    opacity: 0;
    transform: translateY(24px);
    transition: opacity 450ms cubic-bezier(0.16, 1, 0.3, 1) calc(var(--i, 0) * 75ms),
                transform 450ms cubic-bezier(0.16, 1, 0.3, 1) calc(var(--i, 0) * 75ms);
    will-change: opacity, transform;
}

/* Revealed State */
html.js-motion-active .reveal.is-in,
html.js-motion-active .r-item.is-in,
html.js-motion-active .r-plate.is-in,
html.js-motion-active .receipt-card.is-in,
html.js-motion-active .rc-card.is-in,
html.js-motion-active .leaf.is-in,
html.js-motion-active .reg.is-in,
html.js-motion-active .cmp.is-in,
html.js-motion-active .faq-item.is-in,
html.js-motion-active .calc-card.is-in {
    opacity: 1 !important;
    transform: translateY(0) !important;
}

/* Plates seat with slight scale settle */
html.js-motion-active .r-plate {
...
/* Decorative rules draw left-to-right */
html.js-motion-active .r-rule {
    transform: scaleX(0);
    transform-origin: left;
    transition: transform 550ms cubic-bezier(0.16, 1, 0.3, 1) calc(var(--i, 0) * 75ms);
}
html.js-motion-active .r-rule.is-in {
...
/* Prefers Reduced Motion override */
@media (prefers-reduced-motion: reduce) {
    .reveal, .r-item, .r-plate, .r-rule, .receipt-card, .rc-card, .leaf, .reg, .cmp, .faq-item, .calc-card {
        opacity: 1 !important;
        transform: none !important;
        transition: none !important;
        animation: none !important;
