...
.l-modal-tape-delta.left {
    color: var(--g);
}
.l-modal-tape-delta.right {
    color: var(--r);
}
...
.l-console-line .c-time {
    color: #666;
    margin-right: 6px;
}
.l-console-line .c-oracle {
    color: var(--r);
    font-weight: 700;
}
.l-console-line .c-data {
    color: var(--g);
}
.l-modal-details {
    display: grid;
