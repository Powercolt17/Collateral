...
.ln-brand{font-family:'Inter Tight',sans-serif;font-size:16px;font-weight:800;letter-spacing:3.5px;color:#0F172A !important;text-decoration:none;display:inline-flex;align-items:center;gap:14px;text-transform:uppercase}
.logo-wordmark{color:#0F172A !important;text-transform:uppercase}
