...
.ln-brand{font-family:'Inter Tight',sans-serif;font-size:16px;font-weight:800;letter-spacing:3.5px;color:#FFFFFF !important;text-decoration:none;display:inline-flex;align-items:center;gap:14px;text-transform:uppercase}
.logo-wordmark{color:#FFFFFF !important;text-transform:uppercase}
...
.lh1{font-family:'Plus Jakarta Sans',sans-serif;font-weight:900;font-size:clamp(2.6rem, 5.0vw, 4.6rem) !important;line-height:0.98 !important;letter-spacing:-0.025em !important;color:var(--t1);text-transform:uppercase;margin:0 0 16px}
...
.lsub{font-size:17.5px !important;color:var(--t2);line-height:1.6 !important;margin:0 0 28px !important;max-width:580px !important;letter-spacing:-.2px}
.lctas{display:flex;gap:18px !important;flex-wrap:wrap;align-items:center;margin-bottom:32px !important}
...
@media (max-width: 768px) {
  .l-stat-bar-item::after { display: none !important; }
}
...
.oc-duels-card {
  ...
  border: 1.5px solid rgba(28, 35, 51, 0.11) !important;
  border-radius: 16px !important;
  padding: 12px 20px !important;
  box-shadow: 0 8px 24px -16px rgba(28, 35, 51, 0.25) !important;
...
.oc-duel:hover {
  background: rgba(122, 28, 43, 0.03) !important;
}
...
@media (max-width: 620px) {
  ...
  .oc-duel {
    ...
    padding: 14px 16px !important;
    background: #FFFFFF !important;
    border: 1px solid rgba(28, 35, 51, 0.09) !important;
    border-radius: 12px !important;
    margin-bottom: 10px !important;
    box-shadow: 0 2px 8px rgba(28, 35, 51, 0.04) !important;
    width: 100% !important;
  }
  .oc-duel:last-child {
    margin-bottom: 0 !important;
...
/* ═══ INTERACTIVE HERO CONTRACT CARD DECK STYLING ═══ */
.lc-platform-header {
  display: flex !important;
  align-items: center !important;
  gap: 12px !important;
