...
export function renderOverview() {
    return `
        <div class="pb-24 w-full max-w-4xl mx-auto px-6 relative z-10 min-h-screen flex flex-col">
            <main id="view-landing" class="view-section flex flex-col items-start opacity-0 animate-activate">
                
                <!-- HERO WITH RED ENFORCEMENT RULE -->
                <div class="w-full mt-16 flex">
                    <div class="w-[3px] bg-[#921818] mr-6 flex-shrink-0"></div>
                    <div class="flex-1">
                        <h1 class="font-display font-medium text-3xl md:text-5xl leading-[0.95] tracking-tight text-[#0E0E11] mb-4">
                        ...
                        <div class="flex items-center gap-3 mb-8 flex-wrap">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="font-mono text-[9px] uppercase tracking-widest text-[#0E0E11]">SYSTEM STATUS: OPERATIONAL</span>
                            </div>
                            <span class="font-mono text-[9px] text-[#6B6E76]">•</span>
                            <span class="font-mono text-[9px] uppercase tracking-widest text-[#6B6E76]"><span class="text-[#0E0E11]">127</span> ACTIVE</span>
                            <span class="font-mono text-[9px] text-[#6B6E76]">•</span>
                            <span class="font-mono text-[9px] uppercase tracking-widest text-[#6B6E76]"><span class="text-[#0E0E11]">$412,888</span> TVL</span>
                        </div>
                        ...
                        <div class="flex flex-col items-start gap-2">
                            ...
                            <p class="font-mono text-[8px] text-[#6B6E76] uppercase tracking-widest">
                                Execution constitutes binding commitment.
                            </p>
                        </div>
                    </div>
                </div>

                <!-- SECTION I: CONTRACT CLASSIFICATION -->
                <div class="w-full mt-16">
                    <div class="flex items-center gap-3 mb-5">
                        <span class="font-mono text-[10px] text-[#921818] font-medium">I.</span>
                        <h2 class="font-mono text-[10px] text-[#0E0E11] uppercase tracking-widest font-medium">Contract Classification</h2>
                    </div>
                    
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#D9DBE1] border border-[#D9DBE1]">
                        <div class="p-5 bg-white">
                            <div class="flex justify-between items-start mb-2">
                                <span class="font-mono text-[10px] font-medium uppercase tracking-widest text-[#0E0E11]">Conservative</span>
                                <span class="font-mono text-[10px] text-[#6B6E76]">≤1.6X</span>
                            </div>
                            <p class="font-mono text-[9px] text-[#6B6E76] leading-relaxed">High completion probability.<br>Lower return multiple.<br>Capital preservation.</p>
                        </div>
                        
                        <div class="p-5 bg-[#FAFAFA] border-l border-r border-[#0E0E11]">
                            <div class="flex justify-between items-start mb-2">
                                <span class="font-mono text-[10px] font-medium uppercase tracking-widest text-[#0E0E11]">Standard</span>
                        ...
                        <div class="p-5 bg-white">
                            <div class="flex justify-between items-start mb-2">
                                <span class="font-mono text-[10px] font-medium uppercase tracking-widest text-[#0E0E11]">Aggressive</span>
                                <span class="font-mono text-[10px] text-[#A18239] font-medium">2.5X+</span>
                            </div>
                            <p class="font-mono text-[9px] text-[#6B6E76] leading-relaxed">Low completion probability.<br>Maximum forfeiture exposure.<br>Asymmetric outcomes.</p>
                        </div>
                    </div>
                </div>

                <!-- SECTION II: VERIFICATION AUTHORITIES -->
                <div class="w-full mt-12">
                    <div class="flex items-center gap-3 mb-5">
                        <span class="font-mono text-[10px] text-[#921818] font-medium">II.</span>
                        <h2 class="font-mono text-[10px] text-[#0E0E11] uppercase tracking-widest font-medium">Verification Authorities</h2>
                    </div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#D9DBE1] border border-[#D9DBE1]">
                        ...
                        <div class="p-4 bg-white">
                            ...
                            <p class="font-mono text-[9px] text-[#6B6E76] mt-1.5 leading-relaxed">Net revenue thresholds.<br>Manipulation excluded.</p>
                        </div>
                        <div class="p-4 bg-white">
                            <span class="font-mono text-[10px] text-[#6B6E76] uppercase tracking-widest">Additional</span>
                            <p class="font-mono text-[9px] text-[#6B6E76] mt-1.5">Pending.</p>
                        </div>
                    </div>
                    
                    <p class="font-mono text-[8px] text-[#6B6E76] uppercase tracking-widest mt-3">
                        No subjective review. No discretion.
                    </p>
                </div>

                <!-- SECTION III: SETTLEMENT & ENFORCEMENT -->
                <div class="w-full mt-12">
                    <div class="flex items-center gap-3 mb-5">
                        <span class="font-mono text-[10px] text-[#921818] font-medium">III.</span>
                        <h2 class="font-mono text-[10px] text-[#0E0E11] uppercase tracking-widest font-medium">Settlement & Enforcement</h2>
                    </div>
                    
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#D9DBE1] border border-[#D9DBE1]">
                        <div class="p-5 bg-white border-l-2 border-[#1F7A4D]">
                            <span class="font-mono text-[10px] text-[#1F7A4D] uppercase tracking-widest font-medium">On Success</span>
                            <p class="font-mono text-[9px] text-[#6B6E76] leading-relaxed mt-2">Capital released automatically.<br>Incentives paid.<br>No discretionary approval.</p>
                        </div>
                ...
                <!-- FOOTER -->
                <div class="w-full mt-16 pt-6 border-t border-[#D9DBE1]">
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <p class="font-mono text-[8px] text-[#6B6E76] uppercase tracking-widest">
                            All contracts settle publicly. Outcomes are permanent.
                        </p>
                        <a href="#" onclick="window.router.navigate('/ledger'); return false;" class="font-mono text-[8px] text-[#0E0E11] uppercase tracking-widest hover:text-[#921818] transition-colors">
                            View Public Ledger →
                        </a>
                    </div>
                </div>
