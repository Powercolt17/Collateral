    ...
    return `
        <div class="w-full max-w-7xl mx-auto px-6 md:px-10 lg:px-16 relative z-10 min-h-screen">
            <main id="view-landing" class="view-section flex flex-col opacity-0 animate-activate">
                ...
                <!-- 1. HERO -->
                <section class="pt-16 md:pt-28 pb-16 md:pb-20 border-b border-[#E5E7EB]">
                    <h1 class="font-display font-bold text-4xl md:text-6xl lg:text-7xl leading-[1.0] tracking-tight text-[#0A0A0A] mb-6">
                        Lock Capital.<br>
                        Verify Performance.<br>
                        <span class="text-[#B91C1C]">Settle Outcomes.</span>
                    </h1>
                    <p class="font-sans text-base md:text-lg text-[#4B5563] max-w-lg mb-10">
                ...
                <!-- 2. MECHANISM -->
                <section class="py-14 md:py-18 border-b border-[#E5E7EB]">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6">
                        <div class="p-5 md:p-6 border-2 border-[#E5E7EB] bg-[#FAFAFA]">
                            <span class="font-mono text-lg md:text-xl text-[#B91C1C] font-bold block mb-2">01</span>
                        ...
                        <div class="p-5 md:p-6 border-2 border-[#E5E7EB] bg-[#FAFAFA]">
                            <span class="font-mono text-lg md:text-xl text-[#B91C1C] font-bold block mb-2">02</span>
                        ...
                        <div class="p-5 md:p-6 border-2 border-[#E5E7EB] bg-[#FAFAFA]">
                            <span class="font-mono text-lg md:text-xl text-[#B91C1C] font-bold block mb-2">03</span>
                        ...
                        <div class="p-5 md:p-6 border-2 border-[#E5E7EB] bg-[#FAFAFA]">
                            <span class="font-mono text-lg md:text-xl text-[#B91C1C] font-bold block mb-2">04</span>
                ...
                <!-- 3. WHY THIS EXISTS -->
                <section class="py-14 md:py-18 border-b border-[#E5E7EB]">
                    <h2 class="font-display font-bold text-lg md:text-xl text-[#0A0A0A] mb-8 uppercase tracking-wide">Why This Exists</h2>
                    <div class="max-w-3xl space-y-6">
                        <p class="font-sans text-base text-[#4B5563] leading-relaxed">
                            Promises have no cost. Without capital at risk, commitments are indistinguishable from noise.
                        </p>
                        <p class="font-sans text-base text-[#4B5563] leading-relaxed">
                            Enforcement requires consequences. Collateral makes follow-through economically rational — not aspirational.
                        </p>
                        <p class="font-sans text-base text-[#0A0A0A] font-medium">
                ...
                <section class="py-14 md:py-18 border-b border-[#E5E7EB]">
                    ...
                    <p class="font-mono text-xs text-[#6B7280] mt-5 uppercase" style="letter-spacing: 0.1em;">Objective only • Immutable records • No social layer</p>
                </section>
                ...
                <section class="py-14 md:py-18 border-b border-[#E5E7EB]">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-0">
                        ...
                        <div class="p-6 md:p-8 border-l-4 border-[#B91C1C] bg-[#FDF8F8]">
                            <span class="font-mono text-sm text-[#B91C1C] font-bold block mb-3">FAILURE</span>
                ...
                <section class="py-20 md:py-28 text-center">
                    ...
                    <button onclick="window.app.handleInitiate()" class="h-14 px-12 bg-[#0A0A0A] hover:bg-[#1A1A1A] text-white text-sm font-bold uppercase tracking-wide inline-flex items-center justify-center gap-3 transition-colors mx-auto">
                        <span>Commit Capital</span>
                        <i data-lucide="arrow-right" class="w-4 h-4"></i>
                    </button>
                    <p class="font-mono text-xs text-[#9CA3AF] mt-4 uppercase tracking-wider">
                        Serious users only
                    </p>
                </section>
                    ...
                    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                        <div class="flex items-center gap-4">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="font-mono text-xs text-[#6B7280] uppercase tracking-wider">System Operational</span>
                            </div>
                        </div>
                        <p class="font-mono text-xs text-[#6B7280] uppercase tracking-wider">All contracts settle publicly. Outcomes are permanent.</p>
                        <a href="#" onclick="window.router.navigate('/ledger'); return false;" class="font-mono text-xs text-[#0A0A0A] font-medium hover:text-[#B91C1C] transition-colors uppercase tracking-wider">
                            Public Ledger →
                        </a>
                    </div>
                </footer>
