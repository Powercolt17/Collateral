            ...
            <main id="view-landing" class="view-section flex flex-col items-start opacity-0 animate-activate">
                ...
                <div class="w-full mt-10 md:mt-20 flex">
                    ...
                    <div class="flex-1">
                        ...
                        <p class="font-mono text-[10px] md:text-[13px] text-[#6B6E76] uppercase tracking-widest max-w-2xl mb-4 md:mb-8 leading-relaxed">
                        ...
                        <div class="flex items-center gap-2 md:gap-4 mb-6 md:mb-10 flex-wrap">
                            <div class="flex items-center gap-2">
                                ...
                                <span class="font-mono text-[9px] md:text-[11px] uppercase tracking-widest text-[#0E0E11]">SYSTEM STATUS: OPERATIONAL</span>
                            </div>
                ...
                <div class="w-full mt-12 md:mt-20">
                    <div class="flex items-center gap-3 mb-4 md:mb-6">
                        ...
                        <h2 class="font-mono text-[11px] md:text-[13px] text-[#0E0E11] uppercase tracking-widest font-medium">Contract Classification</h2>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#D9DBE1] border border-[#D9DBE1]">
                        <div class="p-4 md:p-6 lg:p-8 bg-white">
                            ...
                            <p class="font-mono text-[9px] md:text-[11px] text-[#6B6E76] leading-relaxed">High completion probability.<br>Lower return multiple.<br>Capital preservation.</p>
                        </div>
                        ...
                        <div class="p-4 md:p-6 lg:p-8 bg-[#FAFAFA] border-l border-r border-[#0E0E11]">
                            ...
                            <p class="font-mono text-[9px] md:text-[11px] text-[#0E0E11] leading-relaxed">Balanced risk profile.<br>Default execution class.<br>Expected variance.</p>
                        </div>
                        ...
                        <div class="p-4 md:p-6 lg:p-8 bg-white">
                            ...
                            <p class="font-mono text-[9px] md:text-[11px] text-[#6B6E76] leading-relaxed">Low completion probability.<br>Maximum forfeiture exposure.<br>Asymmetric outcomes.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="w-full mt-10 md:mt-16">
                    <div class="flex items-center gap-3 mb-4 md:mb-6">
                        ...
                        <h2 class="font-mono text-[11px] md:text-[13px] text-[#0E0E11] uppercase tracking-widest font-medium">Verification Authorities</h2>
                    </div>
                    
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-px bg-[#D9DBE1] border border-[#D9DBE1]">
                        <div class="p-3 md:p-5 lg:p-6 bg-white">
                            <span class="font-mono text-[10px] md:text-[12px] text-[#0E0E11] uppercase tracking-widest font-medium">X / Twitter</span>
                            <p class="font-mono text-[9px] md:text-[11px] text-[#6B6E76] mt-1.5 leading-relaxed">Public metrics only.<br>No private data.</p>
                        </div>
                        <div class="p-3 md:p-5 lg:p-6 bg-white">
                            <span class="font-mono text-[10px] md:text-[12px] text-[#0E0E11] uppercase tracking-widest font-medium">GitHub</span>
                            <p class="font-mono text-[9px] md:text-[11px] text-[#6B6E76] mt-1.5 leading-relaxed">Commits and releases.<br>No subjective review.</p>
                        </div>
                        <div class="p-3 md:p-5 lg:p-6 bg-white">
                            <span class="font-mono text-[10px] md:text-[12px] text-[#0E0E11] uppercase tracking-widest font-medium">Stripe</span>
                            <p class="font-mono text-[9px] md:text-[11px] text-[#6B6E76] mt-1.5 leading-relaxed">Net revenue thresholds.<br>Manipulation excluded.</p>
                        </div>
                        <div class="p-3 md:p-5 lg:p-6 bg-white">
                            <span class="font-mono text-[10px] md:text-[12px] text-[#6B6E76] uppercase tracking-widest">Additional</span>
                ...
                <div class="w-full mt-10 md:mt-16">
                    <div class="flex items-center gap-3 mb-4 md:mb-6">
                        ...
                        <h2 class="font-mono text-[11px] md:text-[13px] text-[#0E0E11] uppercase tracking-widest font-medium">Settlement & Enforcement</h2>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-px bg-[#D9DBE1] border border-[#D9DBE1]">
                        <div class="p-4 md:p-6 lg:p-8 bg-white border-l-2 border-[#1F7A4D]">
                            <span class="font-mono text-[10px] md:text-[12px] text-[#1F7A4D] uppercase tracking-widest font-medium">On Success</span>
                            <p class="font-mono text-[9px] md:text-[11px] text-[#6B6E76] leading-relaxed mt-2 md:mt-3">Capital released automatically.<br>Incentives paid.<br>No discretionary approval.</p>
                        </div>
                        <div class="p-4 md:p-6 lg:p-8 bg-white border-l-2 border-[#921818]">
                            <span class="font-mono text-[10px] md:text-[12px] text-[#921818] uppercase tracking-widest font-medium">On Failure</span>
                            <p class="font-mono text-[9px] md:text-[11px] text-[#6B6E76] leading-relaxed mt-2 md:mt-3">Capital forfeited.<br>No recovery.<br>No appeals.</p>
                        </div>
                    </div>
                </div>
