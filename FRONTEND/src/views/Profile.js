...
export function renderProfile() {
    return `
        <style>
            ...
            .prf-hash{font-size:11px;color:#8A8A8A;font-family:'Inter',monospace;letter-spacing:0.5px;text-transform:uppercase;display:flex;align-items:center;gap:8px}
            .prf-header-actions{display:flex;gap:8px;flex-shrink:0;align-items:center}
            .prf-btn-ghost{display:inline-flex;align-items:center;gap:6px;padding:10px 16px;background:#fff;border:1px solid #E5E5E5;cursor:pointer;font-size:11px;font-weight:700;color:#444444;text-transform:uppercase;letter-spacing:0.5px;font-family:'Inter',monospace;transition:all 0.12s}
            ...
            .prf-card-title{font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;color:#6B6B6B;font-family:'Inter',monospace;margin:0}
            ...
            .prf-sg-label{font-size:10px;color:#8A8A8A;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;font-family:'Inter',monospace;margin-bottom:6px}
            ...
            .prf-feed-amt{font-weight:700;font-family:'Inter',monospace;font-size:12px;color:#111111}
            .prf-feed-time{font-size:10px;color:#8A8A8A;font-family:'Inter',monospace;white-space:nowrap}
            ...
            .prf-id-label{font-size:10px;color:#8A8A8A;text-transform:uppercase;letter-spacing:0.5px;font-family:'Inter',monospace;font-weight:600}
            ...
            .prf-score-hd{display:flex;justify-content:space-between;font-size:10px;color:#8A8A8A;text-transform:uppercase;letter-spacing:0.5px;font-family:'Inter',monospace;margin-bottom:6px}
            ...
            .prf-filter-label{font-size:10px;color:#9ca3af;text-transform:uppercase;font-family:'Inter',monospace;margin-right:4px;font-weight:600;letter-spacing:0.5px}
            ...
            .prf-pcard-scope{font-size:10px;color:#8A8A8A;font-family:'Inter',monospace;margin-bottom:12px}
            ...
            .prf-tl-day{font-size:10px;color:#8A8A8A;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;font-family:'Inter',monospace;padding:16px 0 8px 28px;position:relative}
            ...
            .prf-tl-ref{font-size:10px;color:#8A8A8A;font-family:'Inter',monospace;cursor:pointer}
            .prf-tl-ref:hover{color:#921818}
            .prf-tl-amt{font-size:12px;font-weight:700;font-family:'Inter',monospace;color:#111111}
            .prf-tl-time{font-size:10px;color:#8A8A8A;font-family:'Inter',monospace;margin-left:auto;white-space:nowrap}
            ...
            .prf-sr-sub{font-size:10px;color:#8A8A8A;font-family:'Inter',monospace}
            .prf-sr-right{text-align:right;flex-shrink:0}
            .prf-sr-amt{font-size:14px;font-weight:700;color:#111111;font-family:'Inter',sans-serif}
            .prf-sr-date{font-size:10px;color:#8A8A8A;font-family:'Inter',monospace;margin-top:2px}
            ...
            .prf-sr-detail-label{font-size:9px;color:#8A8A8A;text-transform:uppercase;letter-spacing:0.5px;font-family:'Inter',monospace}
            ...
            .prf-empty-sub{font-size:11px;color:#9ca3af;font-family:'Inter',monospace;margin-bottom:20px}
            ...
            .prf-modal-title{font-size:12px;font-weight:600;color:#111;font-family:'Inter',monospace;text-transform:uppercase;letter-spacing:0.5px}
        ...
        <div class="prf">
            ...
            <div class="prf-content">
                        ...
                        <div>
                            ...
                            <div class="prf-card">
                                <div class="prf-card-hd">
                                    ...
                                    <span style="font-size:10px;color:#9ca3af;font-family:'Inter',monospace" id="activity-count"></span>
                                </div>
                ...
                <div id="tab-history" class="tab-panel hidden">
                    ...
                    <div class="prf-card">
                        <div class="prf-card-hd"><h3 class="prf-card-title">Settlement Records</h3><span style="font-size:10px;color:#9ca3af;font-family:'Inter',monospace" id="sh-count"></span></div>
                ...
                <div id="tab-sources" class="tab-panel hidden">
                    ...
                    <p style="font-size:10px;color:#d4d4d4;font-family:'Inter',monospace;margin-top:12px;text-transform:uppercase;letter-spacing:0.5px">
                ...
                <div id="tab-timeline" class="tab-panel hidden">
                    ...
                    <div class="prf-card">
                        <div class="prf-card-hd">
                            ...
                            <span style="font-size:10px;color:#9ca3af;font-family:'Inter',monospace;text-transform:uppercase">All Events Are Final</span>
                        </div>
                    ...
                    return `<div class="prf-sr" id="sr-${c.id}">
                        ...
                        <div class="prf-sr-detail">
                            <div class="prf-sr-detail-grid">
                                ...
                                <div><div class="prf-sr-detail-label">Contract ID</div><div class="prf-sr-detail-val" style="font-family:'Inter',monospace;font-size:10px">${c.id}</div></div>
