...
![CLTR Token Logo](file:///C:/Users/Colla/.gemini/antigravity/brain/610f4ad6-0f13-474d-9cd3-b7bac860f7a4/cltr_logo_evolution_1783732139899.png)
...
```mermaid
graph TD
    A[User Locks Contract] --> B{Execution Period}
    B -->|Succeeds| C[2% Protocol Fee Charged]
    B -->|Fails| D[Collateral Claimed by Challenger/Pool]
    C --> E[50% Operations / 50% Buyback & Burn]
    E --> F[Supply Deflation]
    F --> G[Increased Value per Token]
    G --> A
```
