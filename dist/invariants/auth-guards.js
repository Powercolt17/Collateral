 ...
 */
function scanForBannedFields(obj, depth, ctx) {
    // Depth limit check
 ...
 */
export function assertNoUserIdFieldsDeep(payload) {
    const ctx = { nodesScanned: 0 };
    const foundField = scanForBannedFields(payload, 0, ctx);
    if (foundField) {
        throw new AuthError(`Do not supply ${foundField}; user identity is derived from authentication.`, 'USER_ID_NOT_ALLOWED');
    }
}
// =============================================================================
 ...
 */
export async function writeRouteGuard(request, reply) {
 ...
 */
export function registerWriteRouteGuards(fastify) {
