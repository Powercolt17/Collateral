...
function getScalingFactor(baseline, metricType) {
    ...
    if (metricType === 'REVENUE') {
        if (baseline >= 100000000)
            return 0.6; // $1M+ revenue
        if (baseline >= 10000000)
            return 0.7; // $100k+
        if (baseline >= 1000000)
            return 0.8; // $10k+
 ...
 */
export function calculateSuggestedTargets(baseline, metricType) {
 ...
 */
export function validateTarget(baseline, target, metricType) {
...
//# sourceMappingURL=target-policy.js.map