-- Migration: Add Live Market Tables
-- Description: Adds contract_templates, market_contract_instances, and market_stats_cache

-- 1. Enum: market_instance_status
DO $$ BEGIN
...
-- 3. Table: market_contract_instances
...
-- Add LEDGER EVENTS for Market Actions (Optional, adhering to ledger-first principle)
ALTER TYPE "ledger_event_type" ADD VALUE IF NOT EXISTS 'MARKET_INSTANCE_PUBLISHED';
ALTER TYPE "ledger_event_type" ADD VALUE IF NOT EXISTS 'MARKET_INSTANCE_EXPIRED';
ALTER TYPE "ledger_event_type" ADD VALUE IF NOT EXISTS 'MARKET_INSTANCE_PAUSED';
